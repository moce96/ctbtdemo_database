...
public class ShipCert {
    ...
    public static void shipCert() {
        ...
        String[] photo = {"http://www.rhhykj.com/uploadfile/201710/20171026120053105.jpg","http://www.rhhykj.com/uploadfile/201710/20171026120013236.jpg","https://www.jyacht.com/up15/image/201509/20150908110288238823.jpg","https://www.jyacht.com/UpFile13/201551510542344.jpg","http://www.xmship.com/upload/201031613039593.jpg"};
...
conn = DriverManager.getConnection(mysqlMessage[1], mysqlMessage[2], mysqlMessage[3]);
                ...
                pstm.setObject(13,randomDate.generateRandomDate("2021-01-01","2021-06-01"));
                pstm.setString(14,"other");
                pstm.setString(15,photo[random.nextInt(photo.length)]);
