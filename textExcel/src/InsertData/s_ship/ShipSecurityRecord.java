...
public class ShipSecurityRecord {
    ...
    public static void shipSecurityRecord() {
        ...
        String[] description = {"合格","不合格","合格","合格","合格","合格","合格"};
...
conn = DriverManager.getConnection(mysqlMessage[1], mysqlMessage[2], mysqlMessage[3]);
                String sql = "INSERT INTO s_shipSecurityRecord(securityCheckId,shipId,securityCheckTime,securityCheckContent,description)" +
                        "VALUES(?,?,?,?,?)";
