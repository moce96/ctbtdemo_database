...
conn = DriverManager.getConnection(mysqlMessage[1], mysqlMessage[2], mysqlMessage[3]);
                String sql = "INSERT INTO z_shipComprehensiveEval(shipId,dangerCheckId,evalTime,evalLevel,evalContent,evalPoint,enclosure,description,checkPerson)" +
                        "VALUES(?,?,?,?,?,?,?,?,?)";
